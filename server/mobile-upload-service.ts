...
function mobilePage(locale: MobilePageLocale): string {
  ...
  const copy = {
    en: {
      pageTitle: 'Upload from phone', title: 'Send media to cut000',
    ...
    ru: {
      pageTitle: 'Загрузка с телефона', title: 'Отправить медиафайлы в cut000',
    ...
    zh: {
      pageTitle: '手机传素材', title: '发送素材到 cut000',
...
<title>cut000 · ${copy.pageTitle}</title><style>
