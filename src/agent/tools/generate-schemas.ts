  ...
  },
  {
    ...
    input_schema: {
      ...
      properties: {
        ...
        stream: { type: 'boolean', description: 'MiniMax HTTP streaming transport. cut000 consumes it server-side and saves one durable audio asset.' },
  ...
  },
  {
    ...
    input_schema: {
      ...
      properties: {
        ...
        stream: { type: 'boolean', description: 'Mureka only. Enable provider streaming phase; cut000 still saves durable final files.' },
